import type { ElasticOffer, LimioObject, Subscription } from "@limio/types"

export function filterOffers(offerItems: ElasticOffer[], subData: LimioObject<Subscription>): ElasticOffer[] {
