...
function PlanSelection({
    ...
    // "years" etc }
    const [selectedAddOnProducts, setSelectedAddOnProducts] = useState<Array<{
        product: string,
        quantity?: number
    }>>([]) // add on product path
            ...
            <div className={"component-container"}>
                <div className="plan-page">
                    <div className="left-side-plan-page border-pp">
                        ...
                        <BillingPlan selectedTerm={selectedTerm} handleTermChange={handleTermChange}
                                     selectedProduct={selectedProduct} termLabels={termLabels}/>
                        <BillingFrequency
                        ...
                        <AddOnOptions selectedAddOnProducts={selectedAddOnProducts}
