...
function PlanSelection({ monthlyTermLabel, oneYearTermLabel, twoYearTermLabel, threeYearTermLabel, basketDescText }: Props): React.Node {
  ...
  // "years" etc }
  const [selectedAddOnProducts, setSelectedAddOnProducts] = useState<Array<{ product: string, quantity?: number }>>([]) // add on product path
      ...
      <div className={"component-container"}>
        <div className="plan-page">
          <div className="left-side-plan-page border-pp">
            ...
            <AddOnOptions selectedAddOnProducts={selectedAddOnProducts} setSelectedAddOnProducts={setSelectedAddOnProducts} selectedProduct={selectedProduct} />
          </div>
          {/* column 2 */}
          <PreviewBasket
            quantity={quantity}
