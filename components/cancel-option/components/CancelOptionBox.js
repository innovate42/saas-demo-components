...
function CancelOptionBox({ boxTitle, boxText, buttonText, highlighted, highlightBoxText, buttonLink }: Props): React.Node {
  const handleClick = () => {
  ...
  return (
    <div className={`basis-650 flex col flex-1 justify-center align-center bg-white p-0 shadow mw-custom mh-max mh-min  ${highlighted ? "highlighted" : ""}`}
